...
namespace GN_Shiro
{
    class EnemyMoveRenderer
    {
        public static int[][] RenderFeindlyTree(int[] board)
        {
            ...
            for (int i = 0; i < 16; i++)
            {
                LogWrite.Log(FreindlyPieces[i].Fix() + "---" + FreindlyPieceLocations[i]);
            }
            ...
            for (int i = 0; i < 16; i++)
            {
                ...
                if (FreindlyPieces[i] > 10 && FreindlyPieces[i] < 20)
                {
                    ...
                    if (FreindlyPieceLocations[i] - 20 == FreindlyPieces[i] - 10 && FreindlyPieceLocations[i].Fix() == 20 && board[FreindlyPieceLocations[i] + 20] == 0 && board[FreindlyPieceLocations[i] + 10] == 0)
                    {
                        ...
                        if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                        {
                    ...
                    if (board[FreindlyPieceLocations[i] + 11].Fix() > 0 || board[FreindlyPieceLocations[i] + 9].Fix() > 0)
                    {
                        ...
                        {
                            //if square down and to the left has a piece on it and is not freindly
                            if (board[FreindlyPieceLocations[i] + 9].Fix() > 0 && board[FreindlyPieceLocations[i] + 9].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - 11] + ", Valued at " + (board[FreindlyPieceLocations[i] - 11].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] + 9].Fix() - 1000);
                                }
                            }
                            //if square down and to the right has a piece on it and is not freindly
                            if (board[FreindlyPieceLocations[i] + 11].Fix() > 0 && board[FreindlyPieceLocations[i] + 11].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - 9] + ", Valued at " + (board[FreindlyPieceLocations[i] - 9].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] + 11].Fix() - 1000);
                                }
                            }
                        }
                ...
                if (FreindlyPieces[i] > 50 && FreindlyPieces[i] < 60)
                {
                    ...
                    for (int j = 1; j < 8; j++)
                    {
                        ...
                        else
                        {
                            ...
                            if (board[FreindlyPieceLocations[i] - (10 * j)].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                TmpBoard[FreindlyPieceLocations[i] - (10 * j)] = board[FreindlyPieceLocations[i]];
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] - (10 * j)));
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - (10 * j)] + ", Valued at " + (board[FreindlyPieceLocations[i] - (10 * j)].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] - (10 * j)].Fix() - 1000);
                                }
                                break;
                            }
                    ...
                    for (int j = 1; j < 8; j++)
                    {
                        ...
                        {
                            //if piece belongs to the enemy
                            if (board[FreindlyPieceLocations[i] + j].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                TmpBoard[FreindlyPieceLocations[i] + j] = board[FreindlyPieceLocations[i]];
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log("     " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] + j));
                                    LogWriter.Log("  Captures:" + board[FreindlyPieceLocations[i] + j] + ", Valued at " + (board[FreindlyPieceLocations[i] + j].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] + j].Fix() - 1000);
                                }
                                break;
                            }
                            //break if it's freindly
                ...
                if (FreindlyPieces[i] > 20 && FreindlyPieces[i] < 30)
                {
                    ...
                    for (int j = 0; j < 9; j++)
                    {
                        ...
                        && FreindlyPieceLocations[i] + PossibleKnightMoves[j] < (FreindlyPieceLocations[i] + PossibleKnightMoves[j]).Fix() + 9 && (FreindlyPieceLocations[i] + PossibleKnightMoves[j]).Fix() < 90)
                        {
                            ...
                            if (board[FreindlyPieceLocations[i] + PossibleKnightMoves[j]].Fix() > 0 && board[FreindlyPieceLocations[i] + PossibleKnightMoves[j]].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                TmpBoard[FreindlyPieceLocations[i] + PossibleKnightMoves[j]] = board[FreindlyPieceLocations[i]];
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] + PossibleKnightMoves[j]));
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] + PossibleKnightMoves[j]] + ", Valued at " + (board[FreindlyPieceLocations[i] + PossibleKnightMoves[j]].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] + PossibleKnightMoves[j]].Fix() - 1000);
                                }
                            }
                        }
                ...
                if (FreindlyPieces[i] > 30 && FreindlyPieces[i] < 40)
                {
                    ...
                    for (int j = 1; j < 8; j++)
                    {
                        ...
                        {
                            //if piece belongs to the enemy
                            if (board[FreindlyPieceLocations[i] - (11 * j)].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                TmpBoard[FreindlyPieceLocations[i] - (11 * j)] = board[FreindlyPieceLocations[i]];
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] - (11 * j)));
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - (11 * j)] + ", Valued at " + (board[FreindlyPieceLocations[i] - (11 * j)].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] - (11 * j)].Fix() - 1000);
                                }
                                break;
                            }
                            //break if it's freindly
                    ...
                    for (int j = 1; j < 8; j++)
                    {
                        ...
                        {
                            //if piece belongs to the enemy
                            if (board[FreindlyPieceLocations[i] - (9 * j)].Fix() < 2000)
                            {
                                Array.Copy(board, TmpBoard, 100);
                                TmpBoard[FreindlyPieceLocations[i]] = 0;
                                TmpBoard[FreindlyPieceLocations[i] - (9 * j)] = board[FreindlyPieceLocations[i]];
                                ...
                                if (EnemyPossibilityProjector.RenderPosition(TmpBoard, KingLocation))
                                {
                                    ...
                                    LogWriter.Log(" " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] - (9 * j)));
                                    LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - (9 * j)] + ", Valued at " + (board[FreindlyPieceLocations[i] - (9 * j)].Fix() - 1000));
                                    NumPossibleMoves++;

                                    //Copy TmpBoard into TreeBoards array and score into TreeScores array
                                    Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                                    TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] - (9 * j)].Fix() - 1000);
                                }
                                break;
                            }
                            //break if it's freindly
                ...
                if (FreindlyPieces[i] > 900 && FreindlyPieces[i] < 950)
                {
                    ...
                    if (board[FreindlyPieceLocations[i] - 10] == 0)
                    {
                        ...
                        else if (EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 10))
                        {
                    ...
                    else
                    {
                        ...
                        TmpBoard[FreindlyPieceLocations[i]] = 0;
                        TmpBoard[FreindlyPieceLocations[i] - 10] = board[FreindlyPieceLocations[i]];
                        if (board[FreindlyPieceLocations[i] - 10].Fix() < 2000 && EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 10))
                        {
                            LogWriter.Log(" Capture move up");
                            LogWriter.Log(" " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] - 10));
                            LogWriter.Log(" Captures:" + board[FreindlyPieceLocations[i] - 10] + ", Valued at " + (board[FreindlyPieceLocations[i] - 10].Fix() - 1000));
                            NumPossibleMoves++;

                            //Copy TmpBoard into TreeBoards array and score into TreeScores array
                            Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                            TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] - 10].Fix() - 1000);
                        }
                    ...
                    if (board[FreindlyPieceLocations[i] + 1] == 0)
                    {
                        ...
                        else if (EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] + 1))
                        {
                    ...
                    else
                    {
                        ...
                        TmpBoard[FreindlyPieceLocations[i]] = 0;
                        TmpBoard[FreindlyPieceLocations[i] + 1] = board[FreindlyPieceLocations[i]];
                        if (board[FreindlyPieceLocations[i] + 1].Fix() < 2000 && EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] + 1))
                        {
                            LogWriter.Log("  Capture move right");
                            LogWriter.Log("     " + FreindlyPieceLocations[i] + "-->" + (FreindlyPieceLocations[i] + 1));
                            LogWriter.Log("  Captures:" + board[FreindlyPieceLocations[i] + 1] + ", Valued at " + (board[FreindlyPieceLocations[i] + 1].Fix() - 1000));
                            NumPossibleMoves++;

                            //Copy TmpBoard into TreeBoards array and score into TreeScores array
                            Array.Copy(TmpBoard, TreeBoards[NumPossibleMoves], 100);
                            TreeScores[NumPossibleMoves] = (board[FreindlyPieceLocations[i] + 1].Fix() - 1000);
                        }
                    ...
                    if (board[FreindlyPieceLocations[i] - 11] == 0)
                    {
                        ...
                        else if (EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 11))
                        {
                    ...
                    else
                    {
                        ...
                        TmpBoard[FreindlyPieceLocations[i]] = 0;
                        TmpBoard[FreindlyPieceLocations[i] - 11] = board[FreindlyPieceLocations[i]];
                        if (board[FreindlyPieceLocations[i] - 11].Fix() < 2000 && EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 11))
                        {
                    ...
                    if (board[FreindlyPieceLocations[i] - 9] == 0)
                    {
                        ...
                        else if (EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 9))
                        {
                    ...
                    else
                    {
                        ...
                        TmpBoard[FreindlyPieceLocations[i]] = 0;
                        TmpBoard[FreindlyPieceLocations[i] - 9] = board[FreindlyPieceLocations[i]];
                        if (board[FreindlyPieceLocations[i] - 9].Fix() < 2000 && EnemyPossibilityProjector.RenderPosition(TmpBoard, FreindlyPieceLocations[i] - 9))
                        {
            ...
            LogWriter.Log("Number of possible hostile countermoves: "+NumPossibleMoves);
            ...
            //transfer move # and move score in array of board for the given tree, value 0 is the number of moves possible with the sent board, 10 is the score
            for (int i = 1; i < TreeBoards.Length; i++)
            {
                TreeBoards[i][0] = NumPossibleMoves;
                TreeBoards[i][10] = TreeScores[i]*-1;
            }
